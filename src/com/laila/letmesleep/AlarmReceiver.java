...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (alarm == null) {
			Log.v("Receiver","AlarmReceiver failed to parse the alarm from the intent");
			return;
		}
		...
		Log.v("Receiver","AlarmReceiver.onReceive() id " + alarm.id + " setFor "
		...
		Intent alarmAlert = new Intent(context, Shake.class);
...
//		Intent notify = new Intent(context, c);
...
//		nm.notify(alarm.id, n);
	...
	private void updateNotification(Context context, Alarm alarm, int timeout) {
		...
		Intent viewAlarm = new Intent(context, AlarmEdit.class);
		viewAlarm.putExtra(DBHelper.COLUMN_ID, alarm.id);

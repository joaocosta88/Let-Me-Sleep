...
public class Alarms {
	...
	public static final String ALARM_ALERT_ACTION = "com.layla.letmesleep.ALARM_ALERT";
	...
	private static void enableAlarmInternal(final Context context,
		...
		Log.i("Alarms", "Enabling alarm with id "+id);
		Cursor c = AlarmTable.getAlarm(id);
		c.moveToFirst();
		enableAlarmInternal(context, new Alarm(c),
				enabled);
	}
	...
	private static void enableAlarmInternal(final Context context,
		...
		AlarmTable.updateAlarm(alarm.id, values);
	}
	...
	public static Alarm calculateNextAlert(final Context context) {
		...
		Cursor cursor = AlarmTable.getAlarms(context);
		if (cursor != null) {
	...
	public static void disableExpiredAlarms(final Context context) {
		Cursor cur = AlarmTable.getAlarms(context);
		long now = System.currentTimeMillis();
